...
def main(result_dir, train_dir, debug = False):
    ...
    for cat in dataStructure.cats:
        ...
        for fn_curGt in gt_fileList:
            ...
            # FN, FP, posNum, negNum = evalExp(cur_gt, cur_prob, thresh, validMap = None, validArea=None)
...
if __name__ == "__main__":
    ...
    # Kevin2018-07-11
    # gt_dir中的gt_file就是原始的标注图像,含三种颜色:粉色[255,0,255](当前道路),黑色[0,0,0](旁路),红色[255,0,0](背景)
    # result_dir的文件名字和相应的gt_dir中的一样,应是灰度图像
